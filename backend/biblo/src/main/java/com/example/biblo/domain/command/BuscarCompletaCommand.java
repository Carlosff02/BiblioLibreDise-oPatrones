...
public class BuscarCompletaCommand implements BuscarCommand {
    ...
    public BuscarCompletaCommand(String titulo, String autor, String idioma, int page, LibroServiceImpl service) {
        this.titulo = titulo;
        this.autor = autor;
        this.idioma = idioma;
        this.page = page;
